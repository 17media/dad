...
describe('Dad functionality', () => {
  ...
  it('if input is second number', () => {
    ...
    expect(tw(UTC0105)).toEqual(new Date('2018-01-05T00:00:00.000Z'));
    expect(ja(UTC0105)).toEqual(new Date('2018-01-05T00:00:00.000Z'));
    expect(indo(UTC0105)).toEqual(new Date('2018-01-05T00:00:00.000Z'));
  });
