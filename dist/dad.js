...
var global$1 = new Function('return this')(); // eslint-disable-line no-new-func
var isBrowser = !!(global$1.document && global$1.document.createElement);
var isNode = Object.prototype.toString.call(typeof process !== 'undefined' && process) === '[object process]';
...
var qsParser = function qsParser() {
  ...
  var qsObj = {};
  var qs = qstring || (isNode ? process.argv.slice(2).join('&') : global.location.search);
